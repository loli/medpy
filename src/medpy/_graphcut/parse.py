...
def apply_mapping(label_image, mapping):
    ...
    @note if the provided label_image is a ndarray, the operation can be executed on the
    array directly, changing its values. If you do not want this to happen, provide a
    copy instead of the original array.
