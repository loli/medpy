...
def boundary_stawiaski2(label_image, (gradient_image)):
    """
    ...
    @return a dictionary with the edges as keys and the respective weights as values
    @rtype dict
    """
    print label_image.shape, gradient_image.shape, scipy.prod(label_image.shape)
