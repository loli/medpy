...
from medpy.unittests.graphcut import TestGenerateCut, TestGraph, TestParse, TestBkMfmc, TestEnergy
...
def main():
    ...
    suite_graphcut.addTests(unittest.TestLoader().loadTestsFromTestCase(TestEnergy))
