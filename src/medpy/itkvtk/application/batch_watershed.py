    ...
    for image in args.images:
        ...
        for threshold in args.thresholds:
            ...
            for level in reversed(sorted(args.levels)): # make sure to start with highest first
                ...
                # !TODO: In some cases, US is not enough to hold the complete number
                # of created labels. Flag a warning in this case? Change output to
                # float? Ensure that not that many labels are created? But required!
